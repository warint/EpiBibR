...
For people less comfortable with R and to allow more people to have access to it, we have also developed a Shiny application.Through the same logic present in our package, researchers can retrieve data from our epidemiology-based bibliography. 
